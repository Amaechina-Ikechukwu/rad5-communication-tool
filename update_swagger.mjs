...
if (!swagger.paths['/channels/{channelId}/media']) swagger.paths['/channels/{channelId}/media'] = channelMediaDef;
if (!swagger.paths['/dms/{recipientId}/media']) swagger.paths['/dms/{recipientId}/media'] = dmMediaDef;
